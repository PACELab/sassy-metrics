# sudo python3 pm.py -l -o tracefile.csv
...
class WattsUp(object):
    ...
    def mode(self, runmode):
        ...
        self.s.write(str.encode('#L,W,3,%s,,%d;' % (runmode, self.interval)))
...
def main(args):
    ...
    if not args.port:
        ...
        if system == 'Darwin':          # Mac OS X
            args.port = '/dev/tty.usbserial-AD02022P'
        elif system == 'Linux':
